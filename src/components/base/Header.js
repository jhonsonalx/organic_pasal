      ...
      <React.Fragment>
            ...
            <div className="container">
                <div className="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div className="main__logo">
                        <h1 className="main__logo--title"><Link className="main__logo--link" to="index.html"><img className="main__logo--img" src="assets/img/logo/nav-log.png" alt="logo-img"/></Link></h1>
                    </div>
                        ...
                        <nav className="header__menu--navigation">
                            <ul className="d-flex">
                                <li className="header__menu--items">
                                    <Link className="header__menu--link" to="index.html">Home 
                                    ...
                                    <ul className="header__sub--menu">
                                        <li className="header__sub--menu__items"><Link to="index.html" className="header__sub--menu__link">Home One</Link></li>
                                        <li className="header__sub--menu__items"><Link to="index-2.html" className="header__sub--menu__link">Home Two</Link></li>
                                        <li className="header__sub--menu__items"><Link to="index-3.html" className="header__sub--menu__link">Home Three</Link></li>
                                        <li className="header__sub--menu__items"><Link to="index-4.html" className="header__sub--menu__link">Home Four</Link></li>
                                    </ul>
                                </li>
                                <li className="header__menu--items mega__menu--items">
                                    <Link className="header__menu--link" to="shop.html">Shop 
                                        <svg className="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg>
                                    </Link>
                                    <ul className="header__mega--menu d-flex">
                                        <li className="header__mega--menu__li">
                                            ...
                                            <ul className="header__mega--sub__menu">
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="shop.html">Shop Left Sidebar</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="shop-right-sidebar.html">Shop Right Sidebar</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="shop-grid.html">Shop Grid</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="shop-grid-list.html">Shop Grid List</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="shop-list.html">Shop List</Link></li>
                                            </ul>
                                        </li>
                                        <li className="header__mega--menu__li">
                                            <span className="header__mega--subtitle">Column Two</span>
                                            <ul className="header__mega--sub__menu">
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="product-details.html">Product Details</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="product-video.html">Video Product</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="product-details.html">Variable Product</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="product-left-sidebar.html">Product Left Sidebar</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="product-gallery.html">Product Gallery</Link></li>
                                            </ul>
                                        </li>
                                        <li className="header__mega--menu__li">
                                            <span className="header__mega--subtitle">Column Three</span>
                                            <ul className="header__mega--sub__menu">
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="my-account.html">My Account</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="my-account-2.html">My Account 2</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="404.html">404 Page</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="login.html">Login Page</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="faq.html">Faq Page</Link></li>
                                            </ul>
                                        </li>
                                        <li className="header__mega--menu__li">
                                            <span className="header__mega--subtitle">Column Four</span>
                                            <ul className="header__mega--sub__menu">
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="compare.html">Compare Pages</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="checkout.html">Checkout page</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="checkout-2.html">Checkout Style 2</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="checkout-3.html">Checkout Style 3</Link></li>
                                                <li className="header__mega--sub__menu_li"><Link className="header__mega--sub__menu--title" to="checkout-4.html">Checkout Style 4</Link></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li className="header__menu--items">
                                    <Link className="header__menu--link" to="blog.html">Blog 
                                        <svg className="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg>
                                    </Link>
                                    <ul className="header__sub--menu">
                                        <li className="header__sub--menu__items"><Link to="blog.html" className="header__sub--menu__link">Blog Grid</Link></li>
                                        <li className="header__sub--menu__items"><Link to="blog-details.html" className="header__sub--menu__link">Blog Details</Link></li>
                                        <li className="header__sub--menu__items"><Link to="blog-left-sidebar.html" className="header__sub--menu__link">Blog Left Sidebar</Link></li>
                                        <li className="header__sub--menu__items"><Link to="blog-right-sidebar.html" className="header__sub--menu__link">Blog Right Sidebar</Link></li>
                                    </ul>
                                </li>
                                <li className="header__menu--items">
                                    ...
                                    <ul className="header__sub--menu">
                                        <li className="header__sub--menu__items"><Link to="about.html" className="header__sub--menu__link">About Us</Link></li>
                                        <li className="header__sub--menu__items"><Link to="contact.html" className="header__sub--menu__link">Contact Us</Link></li>
                                        <li className="header__sub--menu__items"><Link to="cart.html" className="header__sub--menu__link">Cart Page</Link></li>
                                        <li className="header__sub--menu__items"><Link to="portfolio.html" className="header__sub--menu__link">Portfolio Page</Link></li>
                                        <li className="header__sub--menu__items"><Link to="wishlist.html" className="header__sub--menu__link">Wishlist Page</Link></li>
                                        <li className="header__sub--menu__items"><Link to="login.html" className="header__sub--menu__link">Login Page</Link></li>
                                        <li className="header__sub--menu__items"><Link to="404.html" className="header__sub--menu__link">Error Page</Link></li>
                                    </ul>
                                </li>
                                <li className="header__menu--items">
                        ...
                        <div className="dropdown__categories--menu">
                            <ul className="d-none d-lg-block">
                                <li className="categories__menu--items">
                                    <Link className="categories__menu--link" to="shop.html">
                                ...
                                <li className="categories__menu--items">
                                    <Link className="categories__menu--link" to="shop.html"> 
                                        ...
                                        <svg className="categories__menu--right__arrow--icon" xmlns="http://www.w3.org/2000/svg" width="17.007" height="16.831" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M184 112l144 144-144 144"/></svg>
                                    </Link>
                                    <ul className="categories__submenu border-radius-10 d-flex justify-content-between">
                                        <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html"><strong>Fresh Berries</strong></Link>
                                            <ul className="categories__submenu--child">
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">AFresh Seafood </Link></li>
                                            </ul>
                                        </li>
                                        <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html"><strong>Orange Juice</strong></Link>
                                            <ul className="categories__submenu--child">
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                        ...
                                        <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html"><strong>Fresh Nuts</strong></Link>
                                            <ul className="categories__submenu--child">
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                        ...
                                        <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html"><strong>Laura Mercier</strong></Link>
                                            <ul className="categories__submenu--child">
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                ...
                                <li className="categories__menu--items">
                                    ...
                                    <ul className="categories__submenu border-radius-10 d-flex justify-content-between">
                                        <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html"><strong>Hot Offers</strong></Link>
                                            <ul className="categories__submenu--child">
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html"> AFresh Seafood</Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                        ...
                                        <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html"><strong>Fresh Meat</strong></Link>
                                            <ul className="categories__submenu--child">
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                        ...
                                        <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html"><strong>Nature Food</strong></Link>
                                            <ul className="categories__submenu--child">
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                ...
                                <ul className="category__mobile--menu_ul">
                                    ...
                                    <li className="categories__menu--items">
                                        ...
                                        <ul className="category__sub--menu">
                                            <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html">Fresh Berries</Link>
                                                <ul className="category__sub--menu">
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                            ...
                                            <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html">Orange Juice</Link>
                                                <ul className="category__sub--menu">
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                            ...
                                            <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html">Fresh Nuts</Link>
                                                <ul className="category__sub--menu">
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                            ...
                                            <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html">Laura Mercier</Link>
                                                <ul className="category__sub--menu">
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                    ...
                                    <li className="categories__menu--items">
                                        ...
                                        <ul className="category__sub--menu">
                                            <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html">Hot Offers</Link>
                                                <ul className="category__sub--menu">
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                            ...
                                            <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html">Fresh Meat</Link>
                                                <ul className="category__sub--menu">
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                                            ...
                                            <li className="categories__submenu--items"><Link className="categories__submenu--items__text" to="shop.html">Nature Food</Link>
                                                <ul className="category__sub--menu">
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Apple Juice </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Oil and Vinegar </Link></li>
                                                    <li className="categories__submenu--child__items"><Link className="categories__submenu--child__items--link" to="shop.html">Bread and Juice </Link></li>
                    ...
                    <div className="header__right--area d-flex justify-content-between align-items-center">
                        <div className="header__menu">
                            <nav className="header__menu--navigation">
                                <ul className="d-flex">
                                    <li className="header__menu--items">
                                        <Link className="header__menu--link text-white" to="index.html">Home 
                                            <svg className="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                                <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                            </svg>
                                        </Link>
                                    ...
                                    <li className="header__menu--items mega__menu--items">
                                        <Link className="header__menu--link text-white" to="shop.html">Shop 
                                            <svg className="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                                <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                            </svg>
                                        </Link>
                                    ...
                                    <li className="header__menu--items">
                                        <Link className="header__menu--link text-white" to="blog.html">Blog 
                                            <svg className="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                                <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                            </svg>
                                        </Link>
                                    ...
                                    <li className="header__menu--items">
                                        <Link className="header__menu--link text-white" to="contact.html">Contact </Link>  
                                    </li>
                                </ul>
                            </nav>
                        </div>
                        <div className="header__right--info d-flex align-items-center">
                            <div className="account__currency">
                                <Link className="account__currency--link text-white" to="#">
                            ...
                            <div className="suport__contact d-flex align-items-center">
                                ...
                                <p className="suport__contact--text text-white">
                                    ...
                                    <Link className="suport__contact--number" to="tel:09786542214">09 7865 42214</Link>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div className="offcanvas__header">
            <div className="offcanvas__inner">
                <div className="offcanvas__logo">
                    <Link className="offcanvas__logo_link" to="index.html">
                ...
                <nav className="offcanvas__menu">
                    <ul className="offcanvas__menu_ul">
                        <li className="offcanvas__menu_li">
                            <Link className="offcanvas__menu_item" to="index.html">Home</Link>
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li"><Link to="index.html" className="offcanvas__sub_menu_item">Home One</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="index-2.html" className="offcanvas__sub_menu_item">Home Two</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="index-3.html" className="offcanvas__sub_menu_item">Home Three</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="index-4.html" className="offcanvas__sub_menu_item">Home Four</Link></li>
                            </ul>
                        </li>
                        <li className="offcanvas__menu_li">
                            <Link className="offcanvas__menu_item" to="shop.html">Shop</Link>
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li">
                                    <Link to="#" className="offcanvas__sub_menu_item">Column One</Link>
                                    <ul className="offcanvas__sub_menu">
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="shop.html">Shop Left Sidebar</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="shop-right-sidebar.html">Shop Right Sidebar</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="shop-grid.html">Shop Grid</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="shop-grid-list.html">Shop Grid List</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="shop-list.html">Shop List</Link></li>
                                    </ul>
                                </li>
                                <li className="offcanvas__sub_menu_li">
                                    <Link to="#" className="offcanvas__sub_menu_item">Column Two</Link>
                                    <ul className="offcanvas__sub_menu">
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="product-details.html">Product Details</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="product-video.html">Video Product</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="product-details.html">Variable Product</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="product-left-sidebar.html">Product Left Sidebar</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="product-gallery.html">Product Gallery</Link></li>
                                    </ul>
                                </li>
                                <li className="offcanvas__sub_menu_li">
                                    <Link to="#" className="offcanvas__sub_menu_item">Column Three</Link>
                                    <ul className="offcanvas__sub_menu">
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="my-account.html">My Account</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="my-account-2.html">My Account 2</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="404.html">404 Page</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="login.html">Login Page</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="faq.html">Faq Page</Link></li>
                                    </ul>
                                </li>
                                <li className="offcanvas__sub_menu_li">
                                    <Link to="#" className="offcanvas__sub_menu_item">Column Three</Link>
                                    <ul className="offcanvas__sub_menu">
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="compare.html">Compare Pages</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="checkout.html">Checkout page</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="checkout-2.html">Checkout Style 2</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="checkout-3.html">Checkout Style 3</Link></li>
                                        <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="checkout-4.html">Checkout Style 4</Link></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li className="offcanvas__menu_li">
                            <Link className="offcanvas__menu_item" to="blog.html">Blog</Link>
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li"><Link to="blog.html" className="offcanvas__sub_menu_item">Blog Grid</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="blog-details.html" className="offcanvas__sub_menu_item">Blog Details</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="blog-left-sidebar.html" className="offcanvas__sub_menu_item">Blog Left Sidebar</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="blog-right-sidebar.html" className="offcanvas__sub_menu_item">Blog Right Sidebar</Link></li>
                            </ul>
                        </li>
                        <li className="offcanvas__menu_li">
                            <Link className="offcanvas__menu_item" to="#">Pages</Link>
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li"><Link to="about.html" className="offcanvas__sub_menu_item">About Us</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="contact.html" className="offcanvas__sub_menu_item">Contact Us</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="cart.html" className="offcanvas__sub_menu_item">Cart Page</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="portfolio.html" className="offcanvas__sub_menu_item">Portfolio Page</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="wishlist.html" className="offcanvas__sub_menu_item">Wishlist Page</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="login.html" className="offcanvas__sub_menu_item">Login Page</Link></li>
                                <li className="offcanvas__sub_menu_li"><Link to="404.html" className="offcanvas__sub_menu_item">Error Page</Link></li>
                            </ul>
                        </li>
                        <li className="offcanvas__menu_li"><Link className="offcanvas__menu_item" to="about.html">About</Link></li>
                        <li className="offcanvas__menu_li"><Link className="offcanvas__menu_item" to="contact.html">Contact</Link></li>
                    </ul>
                    <div className="offcanvas__account--items">
                        <Link className="offcanvas__account--items__btn d-flex align-items-center" to="login.html">
        ...
        <div className="offcanvas__stikcy--toolbar">
            <ul className="d-flex justify-content-between">
                <li className="offcanvas__stikcy--toolbar__list">
                    <Link className="offcanvas__stikcy--toolbar__btn" to="index.html">
                ...
                <li className="offcanvas__stikcy--toolbar__list">
                    <Link className="offcanvas__stikcy--toolbar__btn" to="shop.html">
                    <span className="offcanvas__stikcy--toolbar__icon"> 
                ...
                <li className="offcanvas__stikcy--toolbar__list">
                    <Link className="offcanvas__stikcy--toolbar__btn" to="wishlist.html">
                        <span className="offcanvas__stikcy--toolbar__icon"> 
                            <svg xmlns="http://www.w3.org/2000/svg" width="18.541" height="15.557" viewBox="0 0 18.541 15.557">
                            <path  d="M71.775,135.51a5.153,5.153,0,0,1,1.267-1.524,4.986,4.986,0,0,1,6.584.358,4.728,4.728,0,0,1,1.174,4.914,10.458,10.458,0,0,1-2.132,3.808,22.591,22.591,0,0,1-5.4,4.558c-.445.282-.9.549-1.356.812a.306.306,0,0,1-.254.013,25.491,25.491,0,0,1-6.279-4.8,11.648,11.648,0,0,1-2.52-4.009,4.957,4.957,0,0,1,.028-3.787,4.629,4.629,0,0,1,3.744-2.863,4.782,4.782,0,0,1,5.086,2.447c.013.019.025.034.057.076Z" transform="translate(-62.498 -132.915)" fill="currentColor"/>
                            </svg> 
        ...
        <div className="offCanvas__minicart">
            ...
            <div className="minicart__product">
                <div className="minicart__product--items d-flex">
                    <div className="minicart__thumb">
                        <Link to="product-details.html"><img src="assets/img/product/product1.png" alt="prduct-img"/></Link>
                    </div>
                    <div className="minicart__text">
                        <h4 className="minicart__subtitle"><Link to="product-details.html">The is Garden Vegetable.</Link></h4>
                ...
                <div className="minicart__product--items d-flex">
                    <div className="minicart__thumb">
                        <Link to="product-details.html"><img src="assets/img/product/product2.png" alt="prduct-img"/></Link>
                    </div>
                    <div className="minicart__text">
                        <h4 className="minicart__subtitle"><Link to="product-details.html">Fresh Tomatoe is organic.</Link></h4>
            ...
            <div className="minicart__conditions text-center">
                ...
                <label className="minicart__conditions--label" for="accept">I agree with the <Link className="minicart__conditions--link" to="privacy-policy.html">Privacy Policy</Link></label>
            </div>
            <div className="minicart__button d-flex justify-content-center">
                <Link className="btn minicart__button--link" to="cart.html">View cart</Link>
                <Link className="btn minicart__button--link" to="checkout.html">Checkout</Link>
            </div>
        </div>
