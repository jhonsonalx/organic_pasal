                                        ...
                                        <div className="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-2 mb--n30">
                                                ...
                                                <div className="product__items product__items2">
                                                    <div className="product__items--thumbnail">
                                                        <Link className="product__items--link" to="product-details">
                                                            <img className="product__items--img product__primary--img" src="assets/img/product/bhindi" alt="product-img"/>
                                            ...
                                            <div className="col mb-30">
                                                <div className="product__items product__items2">
                                                    ...
                                                    <div className="product__items--content product__items2--content text-center">
                                                        <Link className="add__to--cart__btn" to="cart">+ Add to cart</Link>
                                                        <h3 className="product__items--content__title h4"><Link to="product-details">CABBAGE</Link></h3>
                                                        <div className="product__items--price">
                                            ...
                                            <div className="col mb-30">
                                                <div className="product__items product__items2">
                                                    <div className="product__items--thumbnail">
                                                        <Link className="product__items--link" to="product-details">
                                                            <img className="product__items--img product__primary--img" src="assets/img/product/kursani.png" alt="product-img"/>
                                        ...
                                        <div className="row row-cols-1 mb--n30">
                                            <div className="col mb-30">
                                                <div className="product__items product__list--items d-flex">
                                                    ...
                                                    <div className="product__list--items__content">
                                                        <h3 className="product__list--items__content--title h4 mb-10"><Link to="product-details">Vegetables Juices</Link></h3>
                                            ...
                                            <div className="col mb-30">
                                                <div className="product__items product__list--items d-flex">
                                                    ...
                                                    <div className="product__list--items__content">
                                                        <h3 className="product__list--items__content--title h4 mb-10"><Link to="product-details">Red-tomato-isolated</Link></h3>
                                                        <div className="product__items--price mb-10">
                                                            <span className="current__price">$35.00</span>
                                                            <span className="old__price">$42.00</span>
                                                        </div>
                                                        <div className="product__items--rating mb-15 d-flex align-items-center mb-10">
                                                            <ul className="d-flex">
                                                                <li className="product__items--rating__list">
                                            ...
                                            <div className="col mb-30">
                                                <div className="product__items product__list--items d-flex">
                                                    ...
                                                    <div className="product__list--items__content">
                                                        <h3 className="product__list--items__content--title h4 mb-10"><Link to="product-details">Fresh-whole-fish</Link></h3>
                                                        <div className="product__items--price mb-10">
                                                            <span className="current__price">$32.00</span>
                                            ...
                                            <div className="col mb-30">
                                                <div className="product__items product__list--items d-flex">
                                                    ...
                                                    <div className="product__list--items__content">
                                                        <h3 className="product__list--items__content--title h4 mb-10"><Link to="product-details">Raw-onions-surface</Link></h3>
                                                        <div className="product__items--price mb-10">
                                                            <span className="current__price">$38.00</span>
                                                            <span className="old__price">$40.00</span>
                                                        </div>
