                        ...
                        <div  className="shop__sidebar--widget widget__area">
                                    ...
                                    <li  className="widget__categories--menu__list">
                                        ...
                                        <ul  className="widget__categories--sub__menu">
                                            <li  className="widget__categories--sub__menu--list">
                                                <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="shop.html">
                                ...
                                <div  className="product__grid--inner">
                                    <div  className="product__grid--items d-flex align-items-center">
                                        ...
                                        <div  className="product__grid--items--content">
                                            <h3  className="product__grid--items--content__title h4"><Link to="product-details.html">Green-surface</Link></h3>
                                    ...
                                    <div  className="product__grid--items d-flex align-items-center">
                                        ...
                                        <div  className="product__grid--items--content">
                                            <h4  className="product__grid--items--content__title"><Link to="product-details.html">Fresh-whole</Link></h4>
                                            <div  className="product__items--price">
                                    ...
                                    <div  className="product__grid--items d-flex align-items-center">
                                        ...
                                        <div  className="product__grid--items--content">
                                            <h4  className="product__grid--items--content__title"><Link to="product-details.html">Vegetables Juices</Link></h4>
                                            <div  className="product__items--price">
                            ...
                            <div  className="single__widget widget__bg">
                                ...
                                <ul  className="widget__tagcloud">
                                    <li  className="widget__tagcloud--list"><Link className="widget__tagcloud--link" to="shop.html">Organic</Link></li>
                                    <li  className="widget__tagcloud--list"><Link className="widget__tagcloud--link" to="shop.html">Vegetable</Link></li>
                                    <li  className="widget__tagcloud--list"><Link className="widget__tagcloud--link" to="shop.html">Giant</Link></li>
                                    <li  className="widget__tagcloud--list"><Link className="widget__tagcloud--link" to="shop.html">Grocery</Link></li>
                                    <li  className="widget__tagcloud--list"><Link className="widget__tagcloud--link" to="shop.html">Foods</Link></li>
                                    <li  className="widget__tagcloud--list"><Link className="widget__tagcloud--link" to="shop.html">Bakery</Link></li>
                                    <li  className="widget__tagcloud--list"><Link className="widget__tagcloud--link" to="shop.html">Dairies</Link></li>
                                    <li  className="widget__tagcloud--list"><Link className="widget__tagcloud--link" to="shop.html">Nature </Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div id="description"  className="tab_pane active show">
                                            <div  className="product__tab--content">
                                                ...
                                                <div  className="product__tab--content__step">
                                                    <h2  className="product__tab--content__title h4 mb-10">More Details</h2>
                                                    <ul>
                                        ...
                                        <div id="reviews"  className="tab_pane">
                                            <div  className="product__reviews">
                                                <div  className="product__reviews--header">
                                                    ...
                                                    <Link className="actions__newreviews--btn btn" to="#writereview">Write A Review</Link>
                                                </div>
